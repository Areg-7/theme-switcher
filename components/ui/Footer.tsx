...
export const Footer: React.FC = () => {
	return (
		<section className=' bg-slate padding-x padding-t pb-8'>
					...
					<div className='flex flex-col items-start'>
						...
						<div className='flex items-center gap-5 mt-8'>
							{socialMedia.map(icon => (
								<div
									className='flex justify-center items-center w-12 h-12 bg-text-primary rounded-full'
									key={icon.alt}
								>
					...
					<div className='flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap'>
						{footerLinks.map(section => (
							<div key={section.title}>
								<h4 className='font-montserrat text-2xl leading-normal font-medium mb-6 text-text-primary'>
									{section.title}
								</h4>
								<ul>
									{section.links.map(link => (
										<li
											className='mt-3 font-montserrat text-base leading-normal text-text hover:text-text-hover'
											key={link.name}
										>
