  ...
  return (  
    ...
    >
      <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full  max-xl:padding-x pt-28'>
        <p className='text-xl font-montserrat text-text-primary'>
        ...
        <h1 className='mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold'>
          ...
          <br />
          <span className='text-text-primary inline-block mt-3'>Nike</span> Shoes
        </h1>
        ...
        <div className='flex justify-start items-start flex-wrap w-full mt-20 gap-14'>
          {statistics.map((stat, index) => (
            <div key={index}>
              <p className='text-4xl font-palanquin font-bold'><NumberTicker value={stat.value}/>k+</p>
